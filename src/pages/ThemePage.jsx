...
export default function ThemePage() {
  ...
  if (!theme) {
    return (
      <div className="min-h-screen bg-black text-white p-4">
        <p>Theme not found</p>
        <button onClick={() => navigate(-1)} className="text-purple-400 mt-4">
          &larr; Back
        </button>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-black text-white p-4 md:p-8">
      <button onClick={() => navigate(-1)} className="text-purple-400 mb-4">
        &larr; Back
      </button>
      ...
      <button
        ...
        className="mt-4 bg-purple-600 text-white px-3 py-2 rounded"
      >
        Add New Card
      </button>
